...
#ifndef BABSTRACTMESH_H
#define BABSTRACTMESH_H
...
class BAbstractMesh : public BackGenEngine::BAbstractComponent {
        BGE_RTTI_DECLARATION
    public:
        BAbstractMesh ( BackGenEngine::BScene *pc_scene );
        virtual ~BAbstractMesh();
